...
-(void)eventDetailsViewControllerDidCancel: (EventDetailsViewController *)controller
{
    [self dismissViewControllerAnimated: YES completion: nil];
}

-(void)eventDetailsViewControllerDidSave: (EventDetailsViewController *)controller
{
    [self dismissViewControllerAnimated: YES completion: nil];
}
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    ...
    if ([segue.identifier isEqualToString:@"AddEvent"]){
        ...
        EventDetailsViewController *eventDetailsViewController = [[navigationController  viewControllers] objectAtIndex: 0];
